        ...
        >
            <div class="relative pb-48 overflow-hidden">
                <img
                    ...
                    :src="`../../../storage/images/${accommodation_image[0].description}`"
                    alt=""
                />
            </div>
            <div class="p-4">
                ...
                <div class="mt-3 flex items-center">
                    <span class="text-sm font-semibold">Vanaf</span>&nbsp;<span
            ...
            <div
                class="p-4 border-t border-b flex items-center text-sm text-gray-600"
            >
                <svg
                    viewBox="0 0 24 24"
